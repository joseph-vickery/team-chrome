...
#for LD functions 
from LD_functions import ld_dict_maker, ld_graph_maker, ld_csv_maker
import matplotlib 
matplotlib.use('Agg') 
import matplotlib.pyplot as plt
import seaborn as sns
...
def Chromosome(snp_name):
    ...
    #connecting to database
        ...
        return render_template("Chromosome.html", name=snp_name,search_snp=search_snp, form=form)
    except:
        return "No information availabe for rs#: %s." % snp_name
